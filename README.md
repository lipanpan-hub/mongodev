...
running command...
$ mgd (--version)
@lppx/mongodev/1.0.2 win32-x64 node-v24.14.1
$ mgd --help [COMMAND]
USAGE
  $ mgd COMMAND
...
...
_See code: [src/commands/profiler/list.ts](https://github.com/lipanpan-hub/mongodev/blob/v1.0.2/src/commands/profiler/list.ts)_
...
_See code: [src/commands/profiler/reset.ts](https://github.com/lipanpan-hub/mongodev/blob/v1.0.2/src/commands/profiler/reset.ts)_
...
_See code: [src/commands/profiler/show.ts](https://github.com/lipanpan-hub/mongodev/blob/v1.0.2/src/commands/profiler/show.ts)_
